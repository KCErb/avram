...
describe "attribute in forms" do
  it "is a PermittedAttribute" do
    ...
    form.password_confirmation.form_name.should eq("attribute")
  end

  it "generates a list of attribute_attributes" do
    form.attribute_attributes.map(&.name).should eq [:password_confirmation,
                                                     :terms_of_service,
                                                     :best_kind_of_bear,
                                                     :default_is_false]
  end
  ...
  it "sets named args for attribute attributes, leaves other empty" do
